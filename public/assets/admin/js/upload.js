...
var Upload = {
    ...
    config: {
        ...
        previewtpl: '<li class="col-xs-3"><a href="{{fullurl}}" data-url="{{url}}" target="_blank" class="thumbnail"><img src="{{fullurl}}" onerror="this.src=\'/assets/public/image/nopic.png\';this.onerror=null;" class="img-responsive"></a><a href="javascript:;" class="btn btn-danger btn-xs btn-trash"><i class="fa fa-trash"></i></a></li>',
    },
    events: {
        onInit: function (up) {
            //修复少数安卓浏览器无法上传图片的Bug
    ...
    api: {
                ...
                if (preview_id && input_id) {
                    $(document.body).on("keyup change", "#" + input_id, function () {
                        ...
                        $.each(inputArr, function (i, j) {
                            ...
                            var data = {url: j, fullurl: j, data: $(that).data()};
        ...
        send: function (file, onUploadSuccess, onUploadError, onUploadComplete) {
            var index = layer.msg('上传', {offset: 't', time: 0});
